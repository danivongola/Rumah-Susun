...
<head>
    ...
    <title>Rusunawa Gunung Sari Surabaya</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" type="text/css" href="awal/css/isotope.css" media="screen" />
    <link rel="stylesheet" href="awal/js/fancybox/jquery.fancybox.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="awal/css/bootstrap.css">
    <link rel="stylesheet" href="awal/css/bootstrap-theme.css">
    <link href="awal/css/responsive-slider.css" rel="stylesheet">
    <link rel="stylesheet" href="awal/css/animate.css">
    <link rel="stylesheet" href="awal/css/style.css">

    <link rel="stylesheet" href="awal/css/font-awesome.min.css">
    <!-- skin -->
    <link rel="stylesheet" href="awal/skin/default.css">
</head>
    ...
    <div id="header" class="appear">
        ...
        <div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
            ...
            <div class="navbar-header">
                ...
                <h1><a class="navbar-brand" href="index.html" data-0="line-height:90px;" data-300="line-height:50px;">Dinas Pekerjaan Umum Dan Tata Ruang Surabaya
                    </a></h1>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
                    <li class="active"><a href="{{ URL::to('home') }}">Home</a></li>
                     @if(Sentry::check())
                    <li><a href="home/pilihan">Pilihan</a></li>
                    @else
                        ...
                        <div class="responsive-slider" data-spy="responsive-slider" data-autoplay="true">
                            <div class="slides" data-group="slides">
                                <ul>
                                    ...
                                    <div class="slide-body" data-group="slide">
                                        <li><img alt="" class="img-responsive" src="awal/img/9.jpg" width="100%" height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="awal/img/10.jpg" width="100%" height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="awal/img/11.jpg" width="100%" height="350"/></li>
...
<div id="testimonials-3" class="section" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<!-- services -->
<div id="services" class="section pad-bot5 bg-white">
    <div class="container">
...
<!-- spacer section:testimonial -->
<div id="testimonials" class="section" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="align-center">
...
<!-- team -->
<div id="team" class="team-section appear clearfix">
    <div class="container">
        ...
        <div class="row align-center mar-bot45">
            ...
            <div class="col-md-4">
                ...
                <div class="wow bounceIn">
                    <div class="team-member">
                        <div class="profile-picture">
                            <figure><img src="awal/img/members1.jpg" alt=""></figure>
                            <div class="profile-overlay"></div>
                            <div class="profile-social">
                                <div class="icons-wrapper">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
            ...
            <div class="col-md-4">
                <div class="wow bounceIn">
                    <div class="team-member">
                        <div class="profile-picture">
                            <figure><img src="awal/img/members2.jpg" alt=""></figure>
                            <div class="profile-overlay"></div>
                            <div class="profile-social">
                                <div class="icons-wrapper">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
...
<div id="parallax1" class="section pad-top40 pad-bot40 mar-bot20" data-stellar-background-ratio="0.5">
    <div class="container ">
...
<div id="line-pricing" class="line-section line-center">
        ...
        <div class="line-wrap">
            <div class="line-pricing-table">
                <div class="col-md-12 mar-bot10">
                    <div class="pricing-table-wrap col-md-4" data-scrollreveal="enter top over 0.5s after 0.3s">
                        <ul>
...
<!-- spacer section:testimonial -->
<div id="testimonials-2" class="section" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="align-center">
...
<!-- section works -->
<div id="section-works" class="section appear clearfix">
    <div class="container">
                ...
                <div class="row">
                    <div class="portfolio-items isotopeWrapper clearfix" id="3">
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft" data-animation-delay="4.8s">
                                    <img src="awal/img/portfolio/1.jpg" alt="welcome" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 1</a></h5>
                                        <a href="awal/img/portfolio/1.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="awal/img/portfolio/2.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 2</a></h5>
                                        <a href="awal/img/portfolio/2.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="awal/img/portfolio/3.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 3</a></h5>
                                        <a href="awal/img/portfolio/3.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft">
                                    <img src="awal/img/portfolio/4.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 4</a></h5>
                                        <a href="awal/img/portfolio/4.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="awal/img/portfolio/5.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 5</a></h5>
                                        <a href="awal/img/portfolio/5.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="awal/img/portfolio/6.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 6</a></h5>
                                        <a href="awal/img/portfolio/6.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft">
                                    <img src="awal/img/portfolio/7.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 7</a></h5>
                                        <a href="awal/img/portfolio/7.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="awal/img/portfolio/8.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 8</a></h5>
                                        <a href="awal/img/portfolio/8.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="awal/img/portfolio/9.jpg" alt="" />
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Project name 9</a></h5>
                                        <a href="awal/img/portfolio/9.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                    </div>
                                </div>
                            </div>
                        </article>
...
<div id="parallax2" class="section parallax" data-stellar-background-ratio="0.5">
...
<!-- contact -->
<div id="section-contact" class="section appear clearfix">
    <div class="container">
...
<div id="footer" class="section footer">
    <div class="container">
        ...
        <div class="row align-center copyright">
            <div class="col-sm-12"><p>Copyright &copy; 2014 GREEN - by <a href="http://bootstraptaste.com"> Bootstrap</a></p></div>
        </div>
    </div>
...
<script src="awal/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<script src="awal/js/jquery.js"></script>
<script src="awal/js/jquery.easing.1.3.js"></script>
<script src="awal/js/bootstrap.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASm3CwaK9qtcZEWYa-iQwHaGi3gcosAJc&sensor=false"></script>
<script src="awal/js/jquery.isotope.min.js"></script>
<script src="awal/js/jquery.nicescroll.min.js"></script>
<script src="awal/js/fancybox/jquery.fancybox.pack.js"></script>
<script src="awal/js/jquery.parallax-1.1.3.js" type="text/javascript" ></script>
<script src="awal/js/skrollr.min.js"></script>
<script src="awal/js/jquery.scrollTo-1.4.3.1-min.js"></script>
<script src="awal/js/jquery.localscroll-1.2.7-min.js"></script>
<script src="awal/js/stellar.js"></script>
<script src="awal/js/responsive-slider.js"></script>
<script src="awal/js/jquery.appear.js"></script>
<script src="awal/js/validate.js"></script>
<script src="awal/js/grid.js"></script>
<script src="awal/js/main.js"></script>
...
<script src="awal/js/wow.min.js"></script>
<script>
    wow = new WOW(
        {
